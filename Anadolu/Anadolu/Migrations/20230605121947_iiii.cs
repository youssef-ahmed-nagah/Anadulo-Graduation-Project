    ...
    public partial class iiii : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReturnProductsOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReturnProductsOrders_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ReturnProductsOrders_ReturnOrders_ReturnOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnProductsOrders_ProductId",
                table: "ReturnProductsOrders",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnProductsOrders_ReturnOrderId",
                table: "ReturnProductsOrders",
